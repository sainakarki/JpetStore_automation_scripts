 ...
 beforeEach(() => {
  ...
  cy.visit('/');
    ...
    it('verify user can add items to cart from cats category ', () => {
        //cy.get('body').should('contain.text', 'Cats');
        cy.xpath(selectors.cat_ctrgy).click();
        cy.xpath(selectors.manx_product_id).click();
        cy.xpath(selectors.tailless_manx_item_id)
        cy.contains('Add to Cart').should('be.visible');
        cy.xpath(selectors.taillessmanx_crt_btn).click();
        cy.contains('Tailless Manx').should('be.visible');
        //adult male persian
        cy.xpath(selectors.return_to_main_menu_btn).click();
        cy.xpath(selectors.cat_ctrgy).click();
        cy.xpath(selectors.persian_product_id).click();
        cy.contains('Add to Cart').should('be.visible');
        cy.xpath(selectors.adult_male_persian_crt_btn).click();
        cy.contains('Adult Male Persian').should('be.visible');
        //assertion
