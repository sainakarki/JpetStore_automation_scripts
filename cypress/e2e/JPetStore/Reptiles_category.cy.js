...
describe('Add to Cart', () => {
 beforeEach(() => {
  ...
  it('verify user can add items to cart from cats category ', () => {
    //cy.get('body').should('contain.text', 'Reptiles')
    cy.xpath(selectors.reptiles_ctgry).click();
    cy.xpath(selectors.rattlesnake_product_id).click();
    cy.xpath(selectors.venomless_rattlesnake_itemid).click();
    cy.contains('Add to Cart').should('be.visible');
    cy.xpath(selectors.venomless_rattlesnake_crt_btn).click();
    cy.contains('Venomless Rattlesnake').should('be.visible');
    //adult male persian
    cy.xpath(selectors.return_to_main_menu_btn).click();
    cy.xpath(selectors.reptiles_ctgry).click();
    cy.xpath(selectors.iguana_product_id).click();
    cy.contains('Add to Cart').should('be.visible');
    cy.xpath(selectors.green_adult_iguana_crt_btn).click();
    cy.contains('Green Adult Iguana').should('be.visible');
    //assertion
