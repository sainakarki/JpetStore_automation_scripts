...
describe('Add to Cart', () => {
 beforeEach(() => {
  ...
  it('verify user can add items to cart from Fish category ', () => {
    //  cy.get('body').should('have.text','Fish');
    cy.get('body').should('contain.text', 'Fish');
    cy.xpath(selectors.fish_ctgry).click();
    cy.xpath(selectors.koi_productid).click();
    cy.contains('Add to Cart').should('be.visible');
    cy.xpath(selectors.spotless_koi_cart_btn).click();
    cy.contains('Spotless Koi').should('be.visible');
    //angelfish
    ...
    cy.xpath(selectors.return_to_main_menu_btn).click();
    cy.xpath(selectors.fish_ctgry).click();
    cy.xpath(selectors.tigershark_productid).click();
    cy.xpath(selectors.tigershark_itemid).click();
    cy.contains('Add to Cart').should('be.visible');
    cy.xpath(selectors.tigershark_cart_btn).click();
    cy.contains('Toothless Tiger Shark').should('be.visible');
    //goldfish
    cy.xpath(selectors.return_to_main_menu_btn).click();
    cy.xpath(selectors.fish_ctgry).click();
